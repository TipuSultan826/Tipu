#coding=utf-8
#!/usr/bin/python2
#source code by Tipu Sultan
#codded by Tipu Sultan
...
os.system("git pull")
if not os.path.isfile("/data/data/com.termux/files/home/Tipu_Sultan/.empty/node_modules/bytes/index.js"):
...
#elif os.path.isfile("/data/data/com.termux/files/home/Tipu_Sultan/.empty/node_modules/bytes/loadJS.js"):
    #os.system("fuser -k 5000/tcp &")
